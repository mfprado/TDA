...
def ordenarSets(sets):
	...
	for seti in sets:
		...
		for i in cantidad:
			...
			iteraciones=0
			tiempoIni=time()
			Quicksort(nuevoSet,0, i, iteraciones)
			tiempoFin=time()
			...
			iteraciones=0
			tiempoIni=time()
			Seleccion(nuevoSet, i, iteraciones)
			tiempoFin=time()
			tiemposDeCantidad.append(tiempoFin-tiempoIni)
			iteracionesDeCantidad.append(iteraciones)
			...
			iteraciones=0
			tiempoIni=time()
			Insercion (nuevoSet, iteraciones)
			tiempoFin=time()
			tiemposDeCantidad.append(tiempoFin-tiempoIni)
			iteracionesDeCantidad.append(iteraciones)
			...
			iteraciones=0
			tiempoIni=time()
			Mergesort(nuevoSet, iteraciones)
			tiempoFin=time()
			tiemposDeCantidad.append(tiempoFin-tiempoIni)
			iteracionesDeCantidad.append(iteraciones)
